"""This module has various utility functions related to generating files, sanitizing yaml files, etc."""
...
from pyparamgui.schema import SimulationConfig, Settings
...
def _generate_parameter_file(simulation_config: SimulationConfig, model: Model, file_name: str) -> Parameters:
    """
...
def _sanitize_yaml_file(input_file: str, output_file: str) -> None:
    """
    Sanitize a YAML file by removing keys with values that are None, empty lists, or empty dictionaries,
    and save the sanitized content to a new file.
